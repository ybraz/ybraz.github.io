...
Compreender o problema exige que entendamos qual o resultado queremos alcançar e quais são os obstáculos que estão impedindo que o alcancemos. 

Para garantir que compreendemos corretamente o problema, existem duas técnicas muito eficientes:
...
3. Sempre fazer o exercício de "o que eu faria se essa opção não existisse" para a opção que parecer mais óbvia.